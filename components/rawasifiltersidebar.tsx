    ...
    <>
      <style>{`
        ...
        .filter-toggle-tab-v3 {
          ...
          color: #122946; padding: 0 4px; border-radius: 0;
        ...
        .filter-toggle-tab-v3:hover { background: rgba(255, 255, 255, 0.9); width: 28px; }
        ...
        .filter-input:focus { border-color: ${accentColor}; background: rgba(255,255,255,0.15); box-shadow: 0 0 15px rgba(40, 145, 200, 0.2); }
        ...
        /* 🚀 تنسيق التاريخ */
        .date-label { font-size: 10px; color: #475569; display: block; margin-bottom: 5px; }
      ...
      >
        <button className="pin-btn-sidebar" onClick={(e) => { e.stopPropagation(); setIsPinned(!isPinned); }}>
          <span style={{ fontSize: '16px', color: '#122946' }}>
            {isMobile ? '✕' : (isPinned ? '📌' : '📍')}
          </span>
        </button>
