        ...
        <div className="imperial-wrapper" ref={menuRef}>
            ...
            <style>{`
                ...
                .u-badge-grand { 
                    ...
                    box-shadow: 0 5px 15px rgba(168, 87, 60, 0.25);
                }
                ...
                .imperial-divider { height: 2px; background: rgba(255, 255, 255, 0.4); margin: 15px 0; border-radius: 10px; }
