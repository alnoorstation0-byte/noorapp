    ...
    <div style={{ display: 'flex', gap: '15px', alignItems: 'center', background: 'white', padding: '15px', borderRadius: '15px', border: `2px solid ${THEME.border}`, flexWrap: 'wrap', marginBottom: '25px', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
        ...
        <div style={{ flex: '1 1 300px' }}>
          <input
            ...
            style={{ width: '100%', padding: '12px 15px', borderRadius: '10px', border: `1px solid ${THEME.border}`, outline: 'none', fontWeight: 900, fontSize: '15px', color: THEME.primary, background: 'rgba(255, 255, 255, 0.6)' }}
          />
        </div>

        {/* 📅 فلتر التاريخ (من - إلى) */}
        <div style={{ display: 'flex', gap: '10px', flex: '1 1 350px', alignItems: 'center' }}>
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', background: 'rgba(255, 255, 255, 0.6)', padding: '5px 12px', borderRadius: '10px', border: `1px solid ${THEME.border}` }}>
