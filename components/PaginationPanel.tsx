...
export default function PaginationPanel({ totalItems, currentPage, rowsPerPage, onPageChange, onRowsChange }: any) {
  ...
  return (
    <div style={{ 
      ...
      border: '1px solid rgba(40, 145, 200, 0.15)', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' 
    }}>
      ...
      <div style={{ height: '20px', width: '1px', background: 'rgba(40, 145, 200, 0.15)' }} />
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <select 
          ...
          style={{ border: '1px solid rgba(40, 145, 200, 0.15)', borderRadius: '8px', padding: '4px 8px', fontWeight: 800, color: '#1e293b', outline: 'none' }}
        >
