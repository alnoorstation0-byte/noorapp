...
export const TABLE_SCHEMAS: Record<string, string[]> = {
  ...
  "pos_shifts": ["id", "user_id", "delegate_id", "warehouse_id", "opened_at", "closed_at", "starting_cash", "expected_cash", "actual_cash", "total_sales", "total_cash_sales", "total_card_sales", "total_credit_sales", "shortage_overage", "status", "created_at", "total_liters_sold", "meter_total_amount", "meter_sales_variance", "total_expenses", "fleet_operation_id", "closing_notes"],
