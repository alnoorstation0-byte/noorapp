...
export const TABLE_SCHEMAS: Record<string, string[]> = {
  ...
  "job_orders": ["id", "order_number", "boq_budget_id", "contractor_id", "assigned_qty", "unit_price", "status", "start_date", "end_date", "notes", "created_at"],
  ...
  "journal_lines": ["id", "header_id", "account_id", "partner_id", "item_name", "quantity", "unit_price", "debit", "credit", "notes", "debit_account_id", "tax_amount", "tax_rate", "created_at"],
  "labor_daily_logs": ["id", "work_date", "worker_name", "site_ref", "work_item", "production_desc", "unit", "skill_level", "daily_wage", "attendance_value", "sub_contractor", "notes", "created_at", "worker_partner_id", "sub_contractor_id", "is_posted", "work_item_id", "tareeha", "productivity", "completion_percentage", "credit_account_id", "debit_account_id"],
  ...
  "material_issues": ["id", "issue_number", "subcontractor_id", "issue_date", "issue_type", "total_amount", "notes", "jv_id", "is_posted", "created_at", "claim_id", "contractor_text_name"],
  "material_receipt_lines": ["id", "receipt_id", "item_name", "quantity", "unit", "unit_price", "total_price", "boq_id", "created_at"],
  "material_receipts": ["id", "receipt_number", "supplier_id", "account_id", "receipt_date", "total_amount", "status", "attachments", "is_posted", "notes", "created_by", "created_at"],
  ...
  "receipt_vouchers": ["id", "date", "amount", "payment_method", "notes", "partner_id", "invoice_id", "created_at", "updated_at", "receipt_number", "status", "safe_bank_acc_id", "partner_acc_id", "reference_number", "attachment_url"],
  ...
  "violations": ["id", "date", "partner_id", "emp_name", "profession", "site_name", "reason", "amount", "image_url", "is_posted", "created_at"]
};
