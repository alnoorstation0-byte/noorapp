      ...
      <div className="air-glass-wrapper">
        ...
        <style>{`
          ...
          .mesh-gradient-aura {
            ...
            background: 
              radial-gradient(at 0% 0%, rgba(40, 145, 200, 0.08) 0, transparent 50%),
          ...
          .air-loader-gate { height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; background: transparent; }
