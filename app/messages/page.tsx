    ...
    return (
        ...
        <div style={{ height: 'calc(100vh - 120px)', display: 'flex', gap: '20px', padding: '20px', animation: 'fadeUp 0.5s ease-out' }}>
                ...
                <div style={{ width: '320px', background: 'white', borderRadius: '20px', border: `1px solid ${THEME.border}`, display: 'flex', flexDirection: 'column', boxShadow: '0 4px 15px rgba(0,0,0,0.03)', overflow: 'hidden', flexShrink: 0 }}>
                    <div style={{ padding: '20px', borderBottom: `1px solid ${THEME.border}`, background: 'rgba(255, 255, 255, 0.6)' }}>
                ...
                <div style={{ flex: 1, background: 'white', borderRadius: '20px', border: `1px solid ${THEME.border}`, display: 'flex', flexDirection: 'column', boxShadow: '0 4px 15px rgba(0,0,0,0.03)', overflow: 'hidden', position: 'relative' }}>
                    {/* Background Pattern */}
                    <div style={{ position: 'absolute', inset: 0, opacity: 0.03, pointerEvents: 'none', backgroundImage: 'radial-gradient(#122946 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
                    ...
                    {activeUserId ? (
                        <>
                            ...
                            <div style={{ padding: '20px', borderBottom: `1px solid ${THEME.border}`, background: 'rgba(255,255,255,0.9)', backdropFilter: 'blur(10px)', display: 'flex', alignItems: 'center', gap: '15px', zIndex: 1 }}>
                                ...
                                <div>
                                    ...
                                    <span style={{ fontSize: '12px', color: isUserOnline(activeUserId) ? '#10b981' : '#475569', fontWeight: 700 }}>
                            ...
                            <div style={{ flex: 1, overflowY: 'auto', padding: '20px', display: 'flex', flexDirection: 'column', gap: '15px', zIndex: 1 }} className="cinematic-scroll">
                                {isLoadingMessages ? (
                                    ...
                                    <div style={{ textAlign: 'center', margin: 'auto', color: '#475569', fontWeight: 800 }}>
                                    ...
                                    messages.map((msg) => {
                                        ...
                                        return (
                                            <div key={msg.id} style={{ alignSelf: isMine ? 'flex-start' : 'flex-end', maxWidth: '70%' }}>
                                                <div style={{
                                                    background: isMine ? THEME.primary : 'rgba(255, 255, 255, 0.4)',
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '5px', justifyContent: isMine ? 'flex-start' : 'flex-end', padding: '0 5px', position: 'relative' }}>
                                                    ...
                                                    {isMine && (
                                                        <span style={{ fontSize: '10px', color: msg.is_read ? '#3b82f6' : '#475569' }}>
                                                            {msg.is_read ? '✓✓' : '✓'}
                                                        </span>
                                                    )}
                                                    ...
                                                    <div 
                                                        ...
                                                        style={{ width: '14px', height: '14px', borderRadius: '50%', border: '1px solid rgba(40, 145, 200, 0.2)', color: '#475569', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '9px', cursor: 'pointer', fontWeight: 900 }}
                                                    >
                                                        i
                                                    </div>
                                                    ...
                                                    {msgDetailsOpen === msg.id && (
                                                        <div style={{ position: 'absolute', top: '100%', right: isMine ? '0' : 'auto', left: isMine ? 'auto' : '0', marginTop: '5px', background: 'white', border: '1px solid rgba(40, 145, 200, 0.15)', borderRadius: '8px', padding: '10px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)', zIndex: 10, minWidth: '180px', fontSize: '11px', color: '#475569', display: 'flex', flexDirection: 'column', gap: '5px' }}>
                                                            ...
                                                            <div style={{ display: 'flex', justifyContent: 'space-between', color: msg.is_read ? '#10b981' : '#475569' }}>
                            ...
                            <form onSubmit={sendMessage} style={{ padding: '20px', borderTop: `1px solid ${THEME.border}`, background: 'rgba(255,255,255,0.9)', zIndex: 1, display: 'flex', gap: '10px' }}>
                                <input 
                                    ...
                                    style={{ flex: 1, padding: '15px 20px', borderRadius: '30px', border: `1px solid ${THEME.border}`, outline: 'none', background: 'rgba(255, 255, 255, 0.6)', fontSize: '14px', fontWeight: 700 }}
                                />
                        ...
                        <div style={{ margin: 'auto', textAlign: 'center', color: '#475569', zIndex: 1 }}>
