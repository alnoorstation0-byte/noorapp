      ...
      <div className="print-area" style={{ display: 'none' }}>
         <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: `4px solid ${THEME.primary}`, paddingBottom: '12px', marginBottom: '25px' }}>
            <div>
               ...
               <p style={{ margin: '6px 0 0 0', fontWeight: 800, fontSize: '14px', color: THEME.textMain }}>شركة مياه غيام | كشف تفصيلي لشهر: ({monthNameArabic} / {logic.selectedYear})</p>
            </div>
            <img src="/ghayam_logo.png" alt=" RY Logo" style={{ height: '55px', objectFit: 'contain' }} />
         </div>
