    ...
    const modalContent = (
        <div className="print-modal-overlay">
            ...
            <style>{`
                ...
                .action-btn { padding: 10px 22px; border-radius: 12px; border: none; font-weight: 900; font-size: 14px; cursor: pointer; transition: 0.2s; display: inline-flex; align-items: center; justify-content: center; min-height: 44px; }
                .action-btn.print { background: linear-gradient(135deg, #00E5FF, #0284C7); color: #0B0E14; font-weight: 900; box-shadow: 0 4px 12px rgba(0, 229, 255, 0.3); }
            ...
            <div className="print-actions-bar no-print">
                <button onClick={handlePrintOrPDF} className="action-btn print">🖨️ طباعة</button>
            ...
            {printFormat === 'a4' ? (
                ...
                <div className="info-grid">
                    <div className="info-box">
                        ...
                        <table className="inner-table">
                            <tbody>
                                <tr>
                                    <td className="value-cell value-highlight" style={{ paddingBottom: '8px' }}>{record.payee_name || '---'}</td>
                                </tr>
                                <tr>
                ...
                {/* 3️⃣ جدول الأصناف (🚀 يدعم الآن الأصناف المتعددة!) */}
                ...
                <div className="thermal-preview-box">
                    ...
                    <div style={{ textAlign: 'right', marginBottom: '10px' }}>
                        <div>المرجع: {record.expense_number || record.id?.slice(0,8)}</div>
                        <div>التاريخ: {creationDate}</div>
                        <div>حساب السداد: {record.payment_account || '---'}</div>
                    </div>
