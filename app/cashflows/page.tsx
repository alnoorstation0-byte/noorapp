...
export default function CashFlowsPage() {
    ...
    const handleExportExcel = () => {
        if (!filteredData || filteredData.length === 0) return showGlobalToast("لا توجد بيانات لتصديرها!", 'warning');
        ...
        const excelData = filteredData.map((row: any) => {
            ...
            return {
                ...
                'الفرع المربوط': row.project?.Property || '---',
                        ...
                        <thead className="tree-thead">
                            <tr>
                                <th style={{ textAlign: 'right', width: '35%', paddingRight: '30px' }}>
                                    {groupBy === 'partner' ? '👤 اسم الشريك (مورد / مورد / عميل)' : '📅 التاريخ الزمني'}
                                </th>
                                                        ...
                                                        <table className="child-table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style={{ width: '20%', textAlign: 'right' }}>🏢 الفرع / التوجيه</th>
