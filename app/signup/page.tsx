        ...
        <div style={{ 
            ...
            <div className="signup-card">
                ...
                <div style={{ textAlign: 'center', marginBottom: '40px' }}>
                    ...
                    <p style={{ color: '#475569', fontSize: '14px', marginTop: '8px' }}>أنشئ حسابك للوصول إلى كامل صلاحيات النظام</p>
                </div>
                ...
                <form onSubmit={handleSignUp}>
                    ...
                    <div style={{ marginBottom: '25px' }} className="dark-combo">
                        <SmartCombo 
                            ...
                            options={['💼 موظف إداري / مهندس', '👷 مورد خارجي / مورد', '👤 عميل / صاحب فرع']}
                            initialDisplay="💼 موظف إداري / مهندس"
                            onSelect={(val) => {
                                const role = val.includes('موظف') ? 'staff' : val.includes('مورد') ? 'contractor' : 'client';
                                setForm({...form, role});
                            }}
                            strict={true}
                        />
                ...
                <div style={{ marginTop: '35px', textAlign: 'center', fontSize: '14px', color: '#475569', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '25px' }}>
                    لديك حساب بالفعل؟{' '}
