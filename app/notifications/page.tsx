            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', background: 'linear-gradient(135deg, rgba(248, 250, 252, 0.9), rgba(255, 255, 255, 0.8))', padding: '20px', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.5)', backdropFilter: 'blur(10px)', boxShadow: '0 4px 15px rgba(0,0,0,0.03)' }}>
                ...
                {notifications.some(n => !n.is_read) && (
                    <button 
                        ...
                        style={{ background: 'rgba(255, 255, 255, 0.4)', color: '#475569', border: '1px solid rgba(40, 145, 200, 0.2)', padding: '10px 20px', borderRadius: '12px', cursor: 'pointer', fontWeight: 800, transition: '0.3s' }}
                        onMouseOver={(e) => { e.currentTarget.style.background = 'rgba(40, 145, 200, 0.15)'; e.currentTarget.style.color = '#0f172a'; }}
                        onMouseOut={(e) => { e.currentTarget.style.background = 'rgba(255, 255, 255, 0.4)'; e.currentTarget.style.color = '#475569'; }}
                    >
                        ✓ تحديد الكل كمقروء
                    </button>
                )}
