        ...
        setSidebarContent({
            actions: (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', width: '100%' }}>
                    {/* 🛡️ حماية الإضافة */}
                    <SecureAction module="receipts" action="create">
                    ...
                    {/* 🛡️ حماية التعديل */}
                    {canEdit && (
                        <SecureAction module="receipts" action="edit">
                    ...
                    {selectedCount > 0 && (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '10px', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '15px' }}>
                            ...
                            <SecureAction module="receipts" action="post">
                            ...
                            <SecureAction module="receipts" action="delete">
    ...
    return (
        <MasterPage icon="📥" title="سندات القبض والتحصيلات" subtitle="إدارة السندات، المراجعة، والترحيل المحاسبي">
            ...
            {logic.isLoading ? (
                ...
                <div className="clickable-rows summary-glass-card cinematic-scroll" onKeyDown={logic.handleTableKeyDown} tabIndex={0} style={{ outline: 'none' }}>
                    <RawasiSmartTable 
                        data={logic.receipts} 
