    ...
    return (
        <div className="print-wrapper">
            <style>{`
                ...
                .meta-item { border: 1px solid rgba(40, 145, 200, 0.15); padding: 12px; border-radius: 6px; }
                ...
                .statement-table th { background: rgba(255, 255, 255, 0.6); border: 1.5px solid #000; padding: 12px; font-weight: 900; font-size: 13px; }
                ...
                .summary-line { display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid rgba(255, 255, 255, 0.4); font-weight: 800; }
