    ...
    >
      <style>{`
        @media print {
          ...
          .print-table th, .print-table td { border: 1px solid rgba(40, 145, 200, 0.2); padding: 6px 3px; }
      ...
      <div className="print-area" style={{ display: 'none' }}>
         <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: `4px solid ${THEME.primary}`, paddingBottom: '20px', marginBottom: '25px' }}>
            <div>
               ...
               <p style={{ margin: '8px 0 0 0', fontWeight: 700, fontSize: '14px', color: THEME.textMuted }}>شركة مياه غيام | عن شهر ({logic.selectedMonth} / {logic.selectedYear})</p>
               <p style={{ margin: '4px 0 0 0', fontWeight: 600, fontSize: '12px', color: THEME.ruby }}>تاريخ القطع للمسحوبات: {logic.cutoffDate}</p>
            </div>
            <img src="/ghayam_logo.png" alt="Company Logo" style={{ height: '60px', objectFit: 'contain' }} />
         </div>
         ...
         <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '60px', fontSize: '14px', fontWeight: 800, padding: '0 40px' }}>
             <div style={{textAlign: 'center', width: '200px'}}>أعده / محاسب الرواتب<br/><br/><hr style={{borderTop: '2px dashed #475569', margin: '30px 0 10px 0'}}/>الاسم والتوقيع</div>
             <div style={{textAlign: 'center', width: '200px'}}>راجعه / مدير الموارد البشرية<br/><br/><hr style={{borderTop: '2px dashed #475569', margin: '30px 0 10px 0'}}/>الاسم والتوقيع</div>
             <div style={{textAlign: 'center', width: '200px'}}>اعتمده / المدير المالي<br/><br/><hr style={{borderTop: '2px dashed #475569', margin: '30px 0 10px 0'}}/>الاسم والتوقيع</div>
         </div>
      </div>
    </MasterPage>
  );
