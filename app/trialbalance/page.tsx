  ...
  return (
    ...
    >
      <style>{`
        ...
        .tb-table th, .tb-table td { border: 1px solid rgba(40, 145, 200, 0.2); padding: 10px 8px; font-size: 14px; }
        
        .tb-table thead th { color: #000000 !important; font-weight: 900; }
        .tb-table tbody td { color: #000000; } 
        .tb-table tbody tr:hover { background-color: rgba(255, 255, 255, 0.4); }
                  ...
                  <tbody>
                    {logic.records.map((r, i) => (
                      <tr key={i}>
                        ...
                        <td className="number" style={{ color: r.period_debit > 0 ? THEME.success : '#475569', background: 'rgba(255, 255, 255, 0.6)' }}>{r.period_debit > 0 ? formatCurrency(r.period_debit) : '-'}</td>
                        <td className="number" style={{ color: r.period_credit > 0 ? THEME.ruby : '#475569', background: 'rgba(255, 255, 255, 0.6)' }}>{r.period_credit > 0 ? formatCurrency(r.period_credit) : '-'}</td>
                    ...
                    {/* صف الإجماليات */}
                    <tr className="tb-totals" style={{ backgroundColor: isBalanced ? 'rgba(40, 145, 200, 0.15)' : '#fee2e2' }}>
